    ...
    useEffect(() => {
        ...
        const message =
            reason === "user_not_found"
                ? "Your account isn't registered in the intranet. Please use your correct email or contact an admin."
            ...
            <CardContent className="p-8 pt-4 pb-4 flex flex-col gap-8">
                <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    <p className="text-muted-foreground text-sm text-balance">
                        The intranet is a place where shearites can rank and view their CCAs.
                    </p>
                </div>
                <div className="grid gap-6">
                    <Button className="w-full p-5" variant={"outline"} onClick={handleSignIn}>
                ...
                <div className="text-center text-sm">
                    Make sure to use your <b>correct email address</b> registered with Sheares Intranet.
                </div>
            </CardContent>
        </Card>
    )
